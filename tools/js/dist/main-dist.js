...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
	...
	_gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
		var d = function d(a) {
		    ...
		    l = [];f.version = "1.20.4", k.constructor = f, k.kill()._gc = !1, f.killTweensOf = f.killDelayedCallsTo = c.killTweensOf, f.getTweensOf = c.getTweensOf, f.lagSmoothing = c.lagSmoothing, f.ticker = c.ticker, f.render = c.render, k.invalidate = function () {
		...
		var d = function d(a) {
		    ...
		    q = d.prototype = new b();return d.version = "1.20.4", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function (a, b, d, e) {
		...
		var d = function d(b) {
		    ...
		    k = d.prototype = new a();return k.constructor = d, k.kill()._gc = !1, d.version = "1.20.4", k.invalidate = function () {
		...
		var c,
		    ...
		    i = {},
		    j = g.prototype = new a("css");j.constructor = g, g.version = "1.20.4", g.API = 2, g.defaultTransformPerspective = 0, g.defaultSkewType = "compensated", g.defaultSmoothOrigin = !0, j = "px", g.suffixMap = { top: j, right: j, bottom: j, left: j, width: j, height: j, fontSize: j, padding: j, margin: j, perspective: j, lineHeight: "" };var k,
		    l,
		    m,
		    n,
		    o,
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
	...
	var a = function a(b) {
	    ...
	    g = f.prototype;g._newClass = g._oldClass = g._delimiter = "";
...
$(document).ready(function () {
	var $span1 = $('.flipper_container aside:nth-child(1) span:nth-child(1)');
	var $span2 = $('.flipper_container aside:nth-child(1) span:nth-child(2)');
	var $span3 = $('.flipper_container aside:nth-child(3) span:nth-child(1)');
	var $span4 = $('.flipper_container aside:nth-child(3) span:nth-child(2)');
	var logo = $('#logo_container svg');
	var spanSpeed = 1.5;
	var angel = $("h1[data-name='Angel']");
	var davcev = $("h1[data-name='Davcev']");
	var welcome = $("h4[data-name='Welcome']");
	var dotCom = $("h4[data-name='Com']");
	var copy = $('footer p');
	var download = $('.download');
	var flipper = $('.flipper_container');

	var introAnimation = new TimelineMax();

	introAnimation.from($('section'), 1.5, {
		...
		autoAlpha: 0,
		ease: Back.easeOut
	}, 0.2, "-=0.2").staggerFrom($('.social_media_wrapper a'), 0.3, {
		x: -20,
		autoAlpha: 0,
		ease: Back.easeOut
	}, 0.04, '-=0.7').from($('.col_l .block:nth-child(3) p'), 0.5, {
		y: 30,
		autoAlpha: 0,
		ease: Back.easeOut
	}, "-=0.3").from(welcome, 1, {
